...
// (on NEXT_PORT); /api and /mcp — including WebSocket upgrades for terminals and
...
const toApi = (url = "") => url.startsWith("/api/") || url === "/api" || url === "/mcp" || url.startsWith("/mcp/") || url.startsWith("/mcp?");
