...
const MAIN: { href: string; label: string; icon: IconName; kbd: string; match: (p: string) => boolean }[] = [
  ...
  { href: "/resources", label: "Resources", icon: "layers", kbd: "G R", match: (p) => p.startsWith("/resources") },
  { href: "/machines", label: "Machines", icon: "shield", kbd: "G M", match: (p) => p.startsWith("/machines") },
